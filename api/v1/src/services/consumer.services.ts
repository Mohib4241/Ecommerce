...
export const newToken  = async(id : number ,refershToken : string) => {  
...
export const inventory = async() => {
    ...
    try{
        ...
        ('SELECT PRODUCT_NAME , MODEL_NAME ,  BRAND_NAME , CATEGORY_NAME , fname  , lname FROM PRODUCT_DETAIL P JOIN CATEGORY C ON P.CAT_ID = C.ID JOIN USER_INFO U ON P.SID = U.UID')
