...
const consumerController = __importStar(require("../controllers/consumer.controller"));
const verifyToken_1 = require("../middleware/verifyToken");
const verifyRefershToken_1 = require("../middleware/verifyRefershToken");
...
router.post('/refresh', verifyRefershToken_1.verifyRefresh, consumerController.refresh);
router.post('/verifyMobileOTP', consumerController.verifyMobileOTP);
router.put('/changePassword', verifyToken_1.verifyToken, consumerController.changePassword);
...
//# sourceMappingURL=consumer.auth.route.js.map